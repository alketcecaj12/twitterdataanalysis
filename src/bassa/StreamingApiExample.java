...
import Capter2.openauthentication.OAuthExample;
import Chapter2.support.Location.OAuthTokenSecret;

public class StreamingApiExample
{
    OAuthTokenSecret OAuthToken;
    final int RECORDS_TO_PROCESS = 50;
    ...
    final String CONFIG_FILE_PATH = "streaming/bassa.config";
    final String DEF_OUTPATH = "bassa/";
...
//        OAuthToken =  oae.GetUserAccessKeySecret();
    ...
    public void ProcessTwitterStream(InputStream is, String outFilePath)
    {
        ...
        try {
            ...
            System.out.println("JSONTokener istantiated");
                ...
                try {                    
                    ...
                    if (rawtweets.size() >= RECORDS_TO_PROCESS)
                    {
                        ...
                        for (JSONObject jobj : rawtweets) {
                        	System.out.println("started writing records");
