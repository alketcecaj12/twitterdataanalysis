...
public class StreamingApiExample
{
    ...
    final int RECORDS_TO_PROCESS = 30;
    ...
    final String CONFIG_FILE_PATH = "streaming/bologna.config";
    final String DEF_OUTPATH = "bologna/";
...
//        OAuthToken =  oae.GetUserAccessKeySecret();
    ...
    /**
     *  Processes a stream of tweets and writes them to a file one tweet per li
