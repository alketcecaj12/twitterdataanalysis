 ...
 * @author shamanth
 */
package Capter2.openauthentication;
...
{        
    ...
    {
        String accesstoken = "176015580-pClrAhN8DMg7pTwAB28tXPePqSKA8AErLyMJIIDu";
        String accesssecret = "NPPG1GEqS9Jg28gObPQMlgX6owUjgdK2UPs5snmdIOcme";
        OAuthTokenSecret tokensecret = new OAuthTokenSecret(accesstoken,accesssecret);
        return tokensecret;
    }
